const pictosDB = [   
    ...
    { name: "Altéré", description: "Dégâts augmentés de 15 % par altération sur le personnage.", cost: "3", location: "L'Aspirante" },
    ...
    { name: "Assurance", description: "Subit 50% de dégâts en moins mais ne peut pas recevoir de soins.", cost: "20", location: "Falaises de Rochevague" },
    ...
    { name: "Attaque Affaiblissante", description: "Les attaques de base infligent Affaiblissement pendant 1 tour.", cost: "10", location: "Intérieur du Monolithe" },
    ...
    { name: "Attaque Combo II", description: "L'attaque de base permet de porter 1 coup supplémentaire.", cost: "20", location: "Intérieur du Monolithe - Clair-Obscur Chromatique" },
    ...
    { name: "Attaque Fracturante", description: "Dégâts de Fracture augmentés de 50 % lors des attaques de base.", cost: "1", location: "Océan Suspendu" },
    { name: "Attaque Fragilisante", description: "Les attaques de base infligent Vulnérabilité pendant 1 tour.", cost: "10", location: "Océan Suspendu" },
    ...
    { name: "Attaque Renforçante", description: "Les attaques de base confèrent Surpuissance pendant 1 tour.", cost: "10", location: "Vallons Fleuris" },
    ...
    { name: "Au seuil de la mort", description: "Inflige 50% de dégâts en plus si la santé est en dessous de 10%", cost: "5", location: "Falaises de Rochevague" },
    { name: "Bombe Funèbre", description: "Inflige des dégâts à tous les ennemis en mourant", cost: "5", location: "Moisson Dorée" },
    ...
    { name: "Boucliers Affinés", description: "Dégâts augmentés de 30 % tant que le personnage a des boucliers. Mais tous ses boucliers sont perdus au moindre coup subi.", cost: "15", location: "Fleuve Sacré, Sirène" },
    ...
    { name: "Brûlures Critiques", description: "Chances de critique augmentées de 25 % contre les ennemis affectés par Brûlure.", cost: "5", location: "Vallons Fleuris" },
    { name: "Buff Curatif", description: "Récupère 15 % de santé en appliquant un buff.", cost: "10", location: "L'Aspirante" },
    { name: "Canon de verre", description: "Inflige 25 % de dégâts en plus, mais les dégâts subis augmentent eux aussi de 25 %.", cost: "10", location: "Fleuve Sacré, Visages" },
    ...
    { name: "Carapace Prolongée", description: "En appliquant Carapace, sa durée augmente de 2.", cost: "10", location: "Terres Oubliées" },
    { name: "Carapace Surpuissante", description: "Applique également Surpuissance en appliquant Carapace.", cost: "10", location: "Sirène" },
    ...
    { name: "Charges sur Critiques", description: "+20 % de charge Gradient en cas de coup critique. Une fois par tour.", cost: "10", location: "Tour Eternelle" },
    ...
    { name: "Contre Amélioré I", description: "Dégâts de contre augmentés de 50 %.", cost: "3", location: "Océan Suspendu" },
    { name: "Contre Amélioré II", description: "Dégâts de contre augmentés de 75 %.", cost: "5", location: "Visages" },
    { name: "Contre Amélioré III", description: "Dégâts de contre augmentés de 100 %.", cost: "7", location: "Coeur Ardent" },
    ...
    { name: "Critiques sur Faiblesse", description: "Chances de critique augmentées de 25 % contre les ennemis affectés par Faiblesse.", cost: "5", location: "Tour Eternelle" },
    ...
    { name: "Danger Protecteur", description: "Gagne Carapace en tombant sous 50% de santé.", cost: "5", location: "Océan Suspendu" },
    ...
    { name: "Double Brûlure", description: "+1 brûlure pour chaque brûlure infligée.", cost: "30", location: "Fleuve Sacré, Visages" },
    ...
    { name: "Élimination Revigorante", description: "Récupère 50 % de santé en tuant un ennemi.", cost: "5", location: "Terres Oubliées" },
    { name: "Énergie - Attaque I", description: "+1 PA à chaque attaque de base.", cost: "10", location: "Moisson Dorée" },
    ...
    { name: "Énergie - Parade", description: "+1 PA en cas de parade réussie.", cost: "15", location: "Fleuve Sacré" },
    { name: "Énergie - Rapidité", description: "Confère 2PA en appliquant Rapidité.", cost: "10", location: "Tour Eternelle" },
    { name: "Énergie - Surpuissance", description: "Confère 2PA en appliquant Surpuissance.", cost: "10", location: "Lumière Acte III" },
    { name: "Énergie – Tour", description: "+1 PA au début du tour.", cost: "20", location: "Fleuve Sacré, Sirène" },
    { name: "Énergie de saut", description: "+1 PA à chaque contre sauté.", cost: "5", location: "Sanctuaire Ancien" },
    { name: "Énergie Douloureuse", description: "Plus aucun gain de PA en cas de parade réussie, mais +1PA lorsque le personnage se fait toucher.", cost: "10", location: "Falaises de Rochevague" },
    ...
    { name: "Etourdissement opportun", description: "Dégâts augmentés de 30 % contre les cibles étourdies.", cost: "10", location: "Fleuve Sacré, Sanctuaire Ancien" },
    ...
    { name: "Fracture Brûlante", description: "Applique 3 brûlures en fracturant un ennemi.", cost: "3", location: "Coeur Ardent" },
    { name: "Fracture Critique", description: "Dégâts de fracture augmentés de 25 % en cas de coup critique.", cost: "5", location: "Continent" },
    { name: "Fracture Embrasante", description: "Fracturer un ennemi double son nombre de brûlures.", cost: "5", location: "Tour Éternelle" },
    { name: "Fracture Énergisante", description: "+3 PA en infligeant Fracture à un ennemi.", cost: "3", location: "Océan Suspendu" },
    { name: "Fracture Fragilisante", description: "Applique Vulnérabilité en cas de fracture.", cost: "5", location: "L'Aspirante" },
    ...
    { name: "Initiative Améliorée", description: "Dégâts du premier coup augmentés de 50 %. Une fois par combat.", cost: "5", location: "Nid d'Esquie" },
    ...
    { name: "Marque Gratifiante", description: "+2 PA en attaquant une cible marquée. Une fois par tour.", cost: "5", location: "Fleuve Sacré, Ocean Suspendu" },
    { name: "Marque Surpuissante", description: "Gagne Surpuissance en touchant un ennemi marqué.", cost: "5", location: "Manoir Suspendu" },
    ...
    { name: "Mort Énergisante", description: "Lorsque le personnage meurt, +4PA aux alliés.", cost: "5", location: "Terres Oubliées" },
    ...
    { name: "Mort Subite", description: "Tue le personnage au début du combat.", cost: "1", location: "Moisson Dorée" },
    { name: "Parade Curative", description: "Récupèrent 3% de santé à chaque parade réussie.", cost: "5", location: "Continent, Carrière" },
    { name: "Parade Périlleuse", description: "+1 PA en cas de parade réussie, mais les dégâts subis sont doublés.", cost: "5", location: "Falaises de Rochevague, Intérieur du Monolithe" },
    { name: "Parade Renforçante", description: "Chaque parade réussie augmente les dégâts infligés de 5 % jusqu'à la fin du tour suivant. Le fait de subir le moindre dégât dissipe ce buff.", cost: "5", location: "Intérieur du Monolithe" },
    ...
    { name: "Plus vif que fort", description: "Joue toujours deux fois de suite, mais inflige 50 % de dégâts en moins.", cost: "10", location: "Lumière Acte III" },
    { name: "Polyvalence", description: "Après un tir en visée libre, les dégâts d'attaque de base augmentent de 50 % pendant 1 tour.", cost: "5", location: "Sanctuaire de la Nuit Éternelle, Ocean Suspendu" },
    ...
    { name: "Puissance Surpeinte", description: "Les dégâts peuvent excéder 9 999 points.", cost: "5", location: "Intérieur du Monolithe" },
    ...
    { name: "Renaissance Protégée", description: "+1 bouclier quand le personnage est ranimé.", cost: "5", location: "Vallons Fleuris" },
    { name: "Renaissance Régénérante", description: "Confère Régénération pendant 3 tours en revenant à la vie.", cost: "3", location: "Falaises de Rochevague" },
    ...
    { name: "Solidification", description: "+2 boucliers quand la santé du personnage tombe en dessous de 50 %. Une fois par combat.", cost: "10", location: "Fleuve Sacré" },
    { name: "Soutien Efficace", description: "+2 PA en utilisant un objet.", cost: "5", location: "Continent" },
    { name: "Spécialiste des Fractures", description: "Dégâts de Fracture augmentés de 50%, mais dégâts de base réduits de 20%.", cost: "1", location: "Manoir Suspendu" },
    ...
    { name: "Teinte de Vie Énergisante", description: "Les teintes de vie confèrent également 3PA.", cost: "10", location: "Fleuve Sacré, Terres Oubliées" },
    ...
    { name: "Teinte Renforçante", description: "Les teintes énergisantes confèrent également Surpuissance.", cost: "5", location: "Tour Eternelle, Terres Oubliée" },
    ...
    { name: "Tireur d'Élite", description: "Chaque tour, le premier tir en visée libre inflige 200 % de dégâts en plus et offre une possibilité de Fracture.", cost: "15", location: "L'Aspirante" },
    ...
    { name: "Tirs Brûlants", description: "20 % de chances d'appliquer Brûlure sur les tirs en visée libre.", cost: "3", location: "Vallons Fleuris" },
    ...
    { name: "Tirs Protecteurs", description: "20 % de chances de gagner Carapace sur les tirs en visée libre.", cost: "3", location: "Manoir Suspendu" },
    ...
    { name: "Travail d'Équipe", description: "Dégâts augmentés de 10 % si tous les alliés sont encore en vie.", cost: "5", location: "Moisson Dorée" },
    { name: "Tricheur", description: "Joue toujours deux fois de suite.", cost: "40", location: "Continent" },
    { name: "Visée Améliorée", description: "Dégâts de visée libre augmentés de 50 %.", cost: "3", location: "Ocean Suspendu" },
    ...
    { name: "Vulnérabilité Améliorée", description: "+15 % à l'augmentation de dégâts imposée par Vulnérabilité.", cost: "15", location: "Tour Eternelle, Intérieur du Monolith - Melosh (Marchand)" },
];
